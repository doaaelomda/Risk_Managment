...
@Component({
  selector: 'lib-contract-comments',
  imports: [CommonModule, CommentSectionComponent],
  templateUrl: './contract-comments.component.html',
  styleUrl: './contract-comments.component.scss',
})
export class ContractCommentsComponent {
    constructor(
  ...
  FEAT_ID!: number;
  relatedEntityId: number = 1;
  dataEntityId: number = 1;
