...
@Component({
  selector: 'lib-assessment-attachments',
  imports: [
    TranslateModule,
    InputTextModule,
  ...
  templateUrl: './assessment-attachments.component.html',
  styleUrl: './assessment-attachments.component.scss',
})
export class AssessmentAttachmentsComponent implements OnInit {
  env: any;
  ...
  constructor(
    ...
    this._ActivatedRoute.parent?.paramMap.subscribe((params) => {
      this.controlAssessmentID = params.get('id');
          ...
          next: (res) => {
            ...
            this._LayoutService.breadCrumbLinks.next([
              ...
              },
              {
                ...
                icon: '',
                routerLink: `/gfw-portal/compliance/assessments/view/${this.controlAssessmentID}/overview`,
              },
              {
