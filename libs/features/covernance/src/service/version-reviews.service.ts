...
export class VersionReviewsService {
  private readonly searchEndpoint = 'Gov/Review/Search';
  private readonly deleteEndpoint = 'Gov/Review';
  private readonly saveEndpoint = 'Gov/Review';
  private readonly updateEndpoint = 'Gov/Review';
  private readonly getByIdEndpoint = 'Gov/Review';
  private readonly idKey = 'govDocumentReviewID';
