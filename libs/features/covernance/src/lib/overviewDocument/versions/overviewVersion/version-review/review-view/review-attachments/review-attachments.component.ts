...
@Component({
  selector: 'lib-review-attachments',
  ...
  styleUrl: './review-attachments.component.scss',
})
export class ReviewAttachmentsComponent {
    env: any;
  ...
  dataEntityTypeId:number = 84
  FEAT_ID!:number
  fileUsageTypeID:string = '84'
