...
@Component({
  selector: 'lib-attachments-incident-closure',
  imports: [CommonModule, NewAttachListComponent, AttachmentsUiComponent, ViewAttachementComponent, EditAttachmentComponent],
  templateUrl: './attachments-incident-closure.component.html',
  styleUrl: './attachments-incident-closure.component.scss',
})
export class AttachmentsIncidentClosureComponent {
    env: any;
  ...
  dataEntityTypeId:number = 38
  FEAT_ID!:number
  fileUsageTypeID:string = '38'
