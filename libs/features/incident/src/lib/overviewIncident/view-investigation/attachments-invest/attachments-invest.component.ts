...
@Component({
  selector: 'lib-attachments-invest',
  imports: [CommonModule, NewAttachListComponent, AttachmentsUiComponent, ViewAttachementComponent, EditAttachmentComponent],
  templateUrl: './attachments-invest.component.html',
  styleUrl: './attachments-invest.component.scss',
})
export class AttachmentsInvestComponent {
    env: any;
  ...
  dataEntityTypeId:number = 93
  FEAT_ID!:number
  fileUsageTypeID:string = '107'
