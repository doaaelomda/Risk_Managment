...
@Component({
  selector: 'lib-method-likehoods-view',
  imports: [CommonModule, RouterOutlet, SharedTabsComponent],
  templateUrl: './method-likehoods-view.component.html',
  styleUrl: './method-likehoods-view.component.scss',
})
export class MethodLikehoodsViewComponent {
  constructor(
    private _translateS: TranslateService,
    private _activatedRoute: ActivatedRoute,
    private service: MethodologyLikehoodsService,
