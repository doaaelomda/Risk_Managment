...
@Component({
  selector: 'lib-methodology-impacts',
  imports: [
    CommonModule,
    DeleteConfirmPopupComponent,
    Button,
  ...
  templateUrl: './methodology-impacts.component.html',
  styleUrl: './methodology-impacts.component.scss',
})
export class MethodologyImpactsComponent {
  ...
  private readonly FEATURE_NAME = 'IMPACT';
  private readonly featureDisplayName = 'Impact';
  ...
  readonly entityIdField = 'riskImpactID';
  readonly dataEntityId = 91;
  ...
  constructor(
    ...
    private _service: MethodologyImpactsService, // DO NOT REMOVE _service 'its used' !!
  ...
  getParentId() {
    ...
    this.viewRoute = `/gfw-portal/risks-management/methodolgy/${this.methodologyId}/impacts`;
    this.columnControl = {
      type: 'route',
      data: `/gfw-portal/risks-management/methodolgy/${this.methodologyId}/impacts`,
    };
  }
    ...
    this.actionItems = [
      ...
      },
      {
        ...
        command: () => this.toggleDeleteModal(true),
         visible: ()=>this._PermissionSystemService.can('RISKS' , 'METHODOLOGYIMPACT' , 'DELETE')
      },
      {
        label: this.translate.instant(this.labels.update),
        icon: 'fi fi-rr-pencil',
        command: () => this.handleUpdateClick(),
         visible: ()=>this._PermissionSystemService.can('RISKS' , 'METHODOLOGYIMPACT' , 'EDIT')
      },
    ];
  }
  ...
  handleViewClick(): void {
    ...
    this.router.navigate([
      `/gfw-portal/risks-management/methodolgy/${this.methodologyId}/impacts/${this.selectedRow}`,
    ]);
  }
  ...
  save() {
    const canAdd = this._PermissionSystemService.can('RISKS' , 'METHODOLOGYIMPACT' , 'ADD')
    const canEdit = this._PermissionSystemService.can('RISKS' , 'METHODOLOGYIMPACT' , 'EDIT')
  ...
  delete(): void {
     if(!this._PermissionSystemService.can('RISKS' , 'METHODOLOGYIMPACT' , 'DELETE')) return;
