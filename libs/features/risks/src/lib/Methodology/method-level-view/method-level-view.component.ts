...
@Component({
  selector: 'lib-method-level-view',
  imports: [CommonModule,  RouterOutlet, SharedTabsComponent],
  templateUrl: './method-level-view.component.html',
  styleUrl: './method-level-view.component.scss',
})
export class MethodLevelViewComponent {
      constructor(
    private _translateS: TranslateService,
    private _activatedRoute: ActivatedRoute,
    private service: MethodologyLevelsService,
