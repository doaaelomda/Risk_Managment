...
export class MethodologyImpactsService {

  private readonly searchEndpoint = 'RiskMethodology/SearchRiskImpacts';
  private readonly deleteEndpoint = 'RiskMethodology/RiskImpacts';
  private readonly saveEndpoint = 'RiskMethodology/RiskImpacts';
private readonly updateEndpoint = 'RiskMethodology/RiskImpacts';
  private readonly getByIdEndpoint = 'RiskMethodology/RiskImpacts';
  private readonly idKey = 'riskImpactID';
