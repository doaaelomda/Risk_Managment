...
import { NG_VALUE_ACCESSOR, ControlContainer, FormGroupDirective, FormControl, AbstractControl } from '@angular/forms';
import { Dropdown } from 'primeng/dropdown';
import { validations } from '../../models/validation.model';
import { MultiSelectModule } from 'primeng/multiselect';import { TranslateModule } from '@ngx-translate/core';
import { ReactiveFormsModule } from '@angular/forms';
@Component({
  selector: 'lib-dropdown-checkbox',
  imports: [CommonModule, MultiSelectModule , TranslateModule ,ReactiveFormsModule],
...
export class DropdownCheckboxComponent implements OnChanges {
