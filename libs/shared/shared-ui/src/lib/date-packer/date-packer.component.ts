...
@Component({
  selector: 'lib-date-packer',
  imports: [CommonModule,CalendarModule, ReactiveFormsModule, TranslateModule],
  templateUrl: './date-packer.component.html',
  styleUrl: './date-packer.component.scss',
  viewProviders: [{ provide: ControlContainer, useExisting: FormGroupDirective }]
})
export class DatePackerComponent implements OnChanges {
